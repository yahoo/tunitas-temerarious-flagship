...
AC_DEFUN([TFinternal_CHECK_PACKAGES_CANNOT_PROCEED], [
    ...
    CPPFLAGS="${CPPFLAGS} ${opt_tunitas_prefix:+-I$opt_tunitas_prefix/modules -I$opt_tunitas_prefix/include} ${opt_scold_prefix:+-Iopt_scold_prefix/modules -I$opt_scold_prefix/include}"
    AC_CHECK_HEADERS([$1],
                     [ : ok found ],
                     [
